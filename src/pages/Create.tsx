...
import { Check, Film, Music, Book, ImagePlus, Link, User, Upload, FileVideo, FileAudio, File, ArrowLeft } from "lucide-react";
...
const Create = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-yellow-50 via-green-50 to-blue-50">
      ...
      <div className="py-20 px-6 bg-gradient-to-r from-yellow-400 via-yellow-300 to-amber-300">
        <div className="max-w-5xl mx-auto">
          ...
          <h1 className="text-4xl font-bold text-purple-900 mb-2">Tambah Koleksi Baru</h1>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <motion.div className="pt-2 flex gap-4" variants={fadeIn} custom={7}>
                      ...
                      <Button
                        ...
                        className="flex-1 bg-gradient-to-r from-blue-500 to-indigo-600 hover:from-blue-600 hover:to-indigo-700 text-white py-2 transition-all hover:shadow-lg flex items-center justify-center gap-2"
                      >
                        {isSubmitting ? (
                          "Menyimpan..."
                        ) : (
