      ...
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-12">
          <motion.div
            ...
            className="mb-4"
          >
            <span className="text-3xl font-bold text-purple-700 bg-clip-text text-transparent bg-gradient-to-r from-purple-600 to-blue-600">Daarul Ilmi</span>
          </motion.div>
          <motion.h1 
          ...
          >
            ...
            <span className="block bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-indigo-600 mt-2">Pengelolaan Konten</span>
          </motion.h1>
          <motion.p 
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
            transition={{ duration: 0.5, delay: 0.2 }}
            className="mt-4 max-w-2xl mx-auto text-xl text-gray-600 leading-relaxed"
          >
            Kelola semua konten video, audio, dan hadist dengan mudah dan efisien untuk pengalaman pengguna yang lebih baik
          </motion.p>
        </div>

        {/* Feature Cards Section - Moved above statistics */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
            ...
            {features.map((feature, index) => (
              ...
              >
                <Link to={feature.link} className="block">
                  <div className="glass-card rounded-xl p-6 h-full transition-all overflow-hidden group border-2 border-transparent hover:border-blue-200">
                    <div
        ...
        {/* Statistics Section - Moved below features */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.5, delay: 0.3 }}
